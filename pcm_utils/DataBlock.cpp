...
Sample DataBlock::TR2() const {
  return Sample{{samples.R2[13], samples.R2[0], samples.R2[1], samples.R2[2],
                 samples.R2[3], samples.R2[4], samples.R2[5], samples.R2[6],
                 static_cast<uint8_t>(samples.R2[7] ^ samples.R2[13]),
                 samples.R2[8], samples.R2[9], samples.R2[10], samples.R2[11],
                 samples.R2[12]}};
}
...
Sample DataBlock::T2L2() const {
  ...
  return Sample{{L2[12], L2[13], L2[0], L2[1], L2[2], L2[3], L2[4], L2[5],
                 ...
                 static_cast<uint8_t>(L2[7] ^ L2[13]), L2[8], L2[9], L2[10],
                 L2[11]}};
}
...
Sample DataBlock::T32R1() const {
  ...
  return Sample{{R1[11], R1[12], R1[13], R1[0], R1[1], R1[2], R1[3], R1[4],
                 ...
                 static_cast<uint8_t>(R1[7] ^ R1[13]), R1[8], R1[9], R1[10]}};
}
...
Sample DataBlock::T42L1() const {
  ...
  return Sample{{L1[10], L1[11], L1[12], L1[13], L1[0], L1[1], L1[2], L1[3],
                 ...
                 static_cast<uint8_t>(L1[7] ^ L1[13]), L1[8], L1[9]}};
}
...
Sample DataBlock::T52R0() const {
  ...
  return Sample{{R0[9], R0[10], R0[11], R0[12], R0[13], R0[0], R0[1], R0[2],
                 ...
                 static_cast<uint8_t>(R0[7] ^ R0[13]), R0[8]}};
}
...
Sample DataBlock::Correct_P() const {
  return ((((samples.L0 ^ samples.R0) ^ samples.L1) ^ samples.R1) ^
          samples.L2) ^
         samples.R2;
}
...
Sample DataBlock::S_Pn() const { return Correct_P() ^ samples.P; }

Sample DataBlock::S_Qn() const {
  return T6L0() ^ T52R0() ^ T42L1() ^ T32R1() ^ T2L2() ^ TR2() ^ samples.Q;
}
...
bool DataBlock::operator==(const DataBlock &lr) {
  for (auto sample = 0; sample < static_cast<size_t>(ElementNames::COUNT);
       ++sample) {
...
void *DataBlock::ptr() { return m[0].ptr(); }

DataBlock &DataBlock::operator=(const DataBlock &lr) {
  std::memcpy(m, lr.m,
              sizeof(Sample) * static_cast<size_t>(ElementNames::COUNT));
  return *this;
}
